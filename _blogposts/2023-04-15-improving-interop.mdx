...
date: "2023-04-15"
title: Even better interop using customizable variants
badge: roadmap
description: |
  TBD
---
...
Here, each value will be _unboxed_ at runtime. That means that the variant payload will be all that's left at runtime, no "box" holding the value.
