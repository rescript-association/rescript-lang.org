...
description: |
  This post clarifies the goals and commitments of the compiler toolchain
  and gives more context on what to expect in the future.
---

*Note: This post was written in collaboration with the BuckleScript team*

## A Statement for the Future

Our new BuckleScript syntax announcement generated lots of good feedback, but also raised some concerns from community members whose use-cases still align with our goal, but sometimes extend outside of it, and who are worried about further commitments to the ecosystem in the face of new unknowns.
...
It's simply called "new BuckleScript syntax". The extension is `.res` and `.resi` (reminiscent of Reason) as to not overload various existing tools operating on `.ml` and `.re`.
...
**Will I be able to continue writing OCaml/Reason and compile to BuckleScript in the future?**
...
This means we, the official team, get back _more_, not less, time and energy that we can reinvest (thank you again, [Maxim](https://twitter.com/_binary_search)!).
...
Stay tuned and let us know in the [Discourse Forum](https://reasonml.chat) what you think!
