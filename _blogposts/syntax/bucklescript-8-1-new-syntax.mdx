...
category: syntax
badge: release
title: New Syntax for Reason & BuckleScript
description: |
...
- There are a few differences in syntax, documented [here](link here please).
...
Quality-wise, the parser now features excellent error messages, is noticeably faster on projects of all scales, and should be much more robust. The rearchitecture also allows us to release in a more professional manner. We'll go into more details on the motivation and architecture in our upcoming blog posts; these will prove to be **very** interesting and illuminating for all engineers. Stay tuned! In the meantime, for any immediate questions, please ask in this [Discourse thread](link here).

Maxim's effort is our community at its best: one person taking on a daunting challenge where we, admittedly, have dropped the balls. We hope that you'll enjoy his work as much as we did testing it!
