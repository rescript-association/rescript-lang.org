...
function Icon$Table(Props) {
  ...
  return React.createElement("svg", {
              ...
              height: "23",
              width: "25"
            }, React.createElement("defs", undefined, React.createElement("style", undefined, ".prefix__a,.prefix__b,.prefix__d{fill:none}.prefix__a,.prefix__b{stroke-width:1.5px}.prefix__c{stroke:none}")), React.createElement("g", {
                  className: "prefix__a"
