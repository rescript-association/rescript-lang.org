...
let categories: array<Sidebar.Category.t> = [
  {
    name: "Introduction",
    items: [{name: "Overview", href: "/docs/manual/v9.0.0/api"}],
  },
  {
    name: "Modules",
    items: [
      {name: "Js Module", href: "/docs/manual/v9.0.0/api/js"},
      {name: "Belt Stdlib", href: "/docs/manual/v9.0.0/api/belt"},
      {name: "Dom Module", href: "/docs/manual/v9.0.0/api/dom"},
    ],
  },
]
