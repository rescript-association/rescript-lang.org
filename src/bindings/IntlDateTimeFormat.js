...
function Date_options(prim, prim$1, prim$2, prim$3, prim$4, prim$5) {
  var tmp = {};
  if (prim !== undefined) {
    tmp.weekday = Caml_option.valFromOption(prim);
  }
  if (prim$1 !== undefined) {
    tmp.era = Caml_option.valFromOption(prim$1);
  }
  if (prim$2 !== undefined) {
    tmp.year = Caml_option.valFromOption(prim$2);
  }
  if (prim$3 !== undefined) {
    tmp.day = Caml_option.valFromOption(prim$3);
  }
  if (prim$4 !== undefined) {
    tmp.month = Caml_option.valFromOption(prim$4);
  }
  return tmp;
}

function Date_dateTimeFormat(prim, prim$1) {
  return new (Intl.DateTimeFormat)(prim, prim$1);
}

function Date_format(prim, prim$1) {
  return prim.format(prim$1);
}
...
var $$Date = {
  ...
  dateTimeFormat: Date_dateTimeFormat,
  format: Date_format,
  make: make$5
};
