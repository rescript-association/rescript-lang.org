...
OCaml standard library or from the [Js](/apis/latest/js) namespace, e.g. use
[Belt.List](/apis/latest/belt/list) instead of `List` or [Js.List](/apis/latest/js/list)
and [Belt.Array](/apis/latest/belt/array) instead of `Array` or [Js.Array](/apis/latest/js/array).
...
use [Js.String](/apis/latest/js/string) for string functions and [Js.Date](/apis/latest/js/date)
for date functions.)
...
- [Belt.Set](/apis/latest/belt/set)
- [Belt.Set.Int](/apis/latest/belt/set-int)
- [Belt.Set.String](/apis/latest/belt/set-string)
