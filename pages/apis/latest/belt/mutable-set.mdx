...
It also has three specialized inner modules [Belt.MutableSet.Int](/apis/latest/belt/mutable-set-int) and [Belt.MutableSet.String](/apis/latest/belt/mutable-set-string) - This module separates data from function which is more verbose but slightly more efficient
