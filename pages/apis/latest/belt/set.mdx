...
It also has three specialized inner modules [Belt.Set.Int](/apis/latest/belt/set-int), [Belt.Set.String](/apis/latest/belt/set-string) and [Belt.Set.Dict](/apis/latest/belt/set-dict) - This module separates data from function which is more verbose but slightly more efficient
