...
The Dom module offers a canonical set of dom related types third party libraries can depend on. Right now it only provides the types, no functions to manipulate the types whatsoever.
