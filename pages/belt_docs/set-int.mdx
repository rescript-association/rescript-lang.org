...
set->Belt.Set.Int.mergeMany([|5, 4, 3, 2, 1|]);
set->Belt.Set.Int.toArray; /* [|1, 2, 3, 4, 5|] */
```
...
set->Belt.Set.Int.removeMany([|5, 4, 3, 2, 1|]);
set->Belt.Set.Int.toArray; /* [||] */
```
...
Belt.Set.Int.toArray(s0) == Belt.Set.Int.toArray(s1); /* true */
```
