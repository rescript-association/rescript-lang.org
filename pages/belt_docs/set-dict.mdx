...
set->Belt.Set.Dict.mergeMany([|5, 4, 3, 2, 1|], ~cmp=IntCmp.cmp);
set->Belt.Set.Dict.toArray; /* [|1, 2, 3, 4, 5|] */
```
...
set->Belt.Set.Dict.removeMany([|5, 4, 3, 2, 1|], ~cmp=IntCmp.cmp);
set->Belt.Set.Dict.toArray; /* [||] */
```
