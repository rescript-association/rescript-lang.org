...
set->Belt.Set.String.toArray; /* [|"apple", "banana", "orange", "strawberry"|] */
```
...
set->Belt.Set.String.removeMany([|"strawberry", "apple", "banana", "orange"|]);
set->Belt.Set.String.toArray; /* [||] */
```
...
Belt.Set.String.toArray(s0) == Belt.Set.String.toArray(s1); /* true */
```
