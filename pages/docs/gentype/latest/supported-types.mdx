...
overview on how `genType`'s convertion works on different types.
...
[Variants.res](https://github.com/reason-association/genType/blob/master/examples/typescript-react-example/src/Variants.res)
and
[VariantsWithPayload.res](https://github.com/reason-association/genType/blob/master/examples/typescript-react-example/src/VariantsWithPayload.res).
...
[ImmutableArray.res/.resi](https://github.com/reason-association/genType/blob/master/examples/typescript-react-example/src/ImmutableArray.resi), which currently needs to be added to your project.
...
ReasonReact record components (deprecated) with props of Reason types `t1`, `t2`, `t3` are exported as reactjs components with props of the JS types corresponding to `t1`, `t2`, `t3`. The annotation is on the `make` function: `[@genType] let make ...`.
...
defines a type which maps to `weekday` in `SomeFlowTypes.js`.  See for example
[Types.re](https://github.com/cristianoc/genType/blob/master/examples/flow-react-example/src/Types.re)
and [SomeFlowTypes.js](https://github.com/cristianoc/genType/blob/master/examples/flow-react-example/src/SomeFlowTypes.js).
...
See for example [Types.re](https://github.com/cristianoc/genType/blob/master/examples/typescript-react-example/src/nested/Types.re).
