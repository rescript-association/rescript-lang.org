...
More info
[here](/docs/manual/latest/record#Record%20Needs%20an%20Explicit%20Definition).
...
This is a common mistake. Please see BuckleScript's [Import an ES6 Default Value](/docs/reason-compiler/latest/import-export#Import%20an%20ES6%20Default%20Value). Aka, instead of:
