...
In ReactJS, `<Menu banner={MyBanner} />` is easy; in ReasonReact, we can't trivially pass the whole component module (it wouldn't even be syntactically valid because a module resides in [another layer of the language](/docs/manual/latest/module)). Solution:
