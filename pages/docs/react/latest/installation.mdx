...
**Note** JSX v4 is newly introduced with the idomatic record-based representation of component. If your dependecies are not compatible with v4 yet, then you can use v3 in the same project. Check out the details in [Migrate from v3](http://localhost:3000/docs/react/latest/migrate-from-v3)
