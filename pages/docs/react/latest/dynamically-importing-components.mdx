---
title: Dynamically Importing Components
description: "Details on how to use the React.lazy_ API to dynamically import components"
canonical: "/docs/react/latest/dynamically-importing-components"
---
...
ReScript comes with APIs for doing dynamic imports both for single values and for entire modules. These APIs, together with `React.lazy_`, let's you dynamically import React components easily.

Let's look at a small example. First let's define a simple component:
