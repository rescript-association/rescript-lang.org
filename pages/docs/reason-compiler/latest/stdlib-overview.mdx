...
- [Js](/apis/javascript/js/latest): all the familiar JS APIs and modules are here! E.g. if you want to use the [JS Array API](/apis/javascript/latest/js/array) over the [OCaml Array API](https://caml.inria.fr/pub/docs/manual-ocaml-4.06/libref/Array.html) because you're more familiar with the former, go ahead.
- [Belt](/apis/javascript/belt/latest): the BuckleScript standard library. This standard library provides useful functions in addition to the OCaml standard library and should be preferred when compiling to JavaScript.
