...
**Note** that for more type-safety you'll probably want to [constrain](function#Constrain%20Arguments%20Better) the `_method` parameter type to only the acceptable values.
