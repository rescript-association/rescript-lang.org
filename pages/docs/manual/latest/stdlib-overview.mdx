...
- [Js](/apis/javascript/latest/js): all the familiar JS APIs and modules are here! E.g. the [JS Array API](/apis/javascript/latest/js/array).
...
- [Belt](/apis/javascript/latest/belt): extra ReScript data structures & helpers. This module provides useful functions in addition to the JS libraries above that you're used to.
