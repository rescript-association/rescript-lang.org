...
Since we compile to clean readable JavaScript files the rest of your existing toolchain (e.g. Babel and Webpack) should just work.

See the [Export to JS guide](import-from-export-to-js#export-to-javascript) to learn how to import ReScript compiled modules into your exising project.

See the [Convert from JS guide](converting-from-js) to learn how to convert existing JS code to ReScript.
