...
\* This is the Reason spiritual equivalent; it doesn't mean it compiles to JS' object! To compile to the latter, see [here](object.md#Tip%20&%20Tricks).
...
\* Again, only a spiritual equivalent; Reason doesn't have nulls, nor null bugs! But it does have [an option type](newcomer-examples.md#Using%20the%20,[object%20Object],%20type) for when you actually need nullability.
