...
Types are the highlight of ReScript! Here, you get a glimpse of why so many are excited about them.
...
ReScript knows that `score` is an `int`, judging by the value `10`. This is called **inference**.
...
## Design Decisions
ReScript's type system is the crystallization of decades of research and engineering. Here are a few highlights:
