...
If you come from JavaScript, **a Reason object doesn't compile to a JS object**. For that, try BuckleScript's [special feature](/docs/reason-compiler/latest/object#Abstract%20Record%20Mode).
