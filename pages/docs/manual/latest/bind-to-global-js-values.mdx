...
**First**, make sure the value you'd like to model doesn't already exist in our [provided API](/apis/javascript/latest/js).
...
(We already provide `setTimeout`, `clearTimeout` and others in the [Js.Global](/apis/javascript/latest/js/global) module).
