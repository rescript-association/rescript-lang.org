...
Belt is currently mostly covering collection types. It has no string or date functions yet, although Belt.String is in the works. In the meantime, use [Js.String](/apis/latest/js/string) for string functions and [Js.Date](/apis/latest/js/date) for date functions.
