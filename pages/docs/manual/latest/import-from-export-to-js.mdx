...
### Import a JSX element from a JavaScript module

Sometimes you need to use a library that requires you to insert an element in your JSX.
This example shows how you would import the JSX element needed from [react-hot-toast](https://react-hot-toast.com/).
...
Put the above in a file called `Toaster.res` and then you can use it in you JSX as `<Toaster/>`
