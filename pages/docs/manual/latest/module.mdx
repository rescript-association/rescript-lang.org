...
As another alternative to `open`ing a module, you can also destructure values of a module into separate let bindings (similarly on how we'd destructure an object in JavaScript). This is helpful if you don't want to pollute your module space with functions and values you don't need.
