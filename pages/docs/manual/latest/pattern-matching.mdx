...
```res
switch myList {
| list{} => Js.log("Empty list")
| list{a, ...theRest} => Js.log("list with the head value " ++ a)
}

switch myArray {
| [1, 2] => Js.log("This is an array with item 1 and 2")
| [] => Js.log("This array has no element")
| _ => Js.log("This is an array")
}
```
...
Using a ReScript `switch` for the first time might make you feel like you've been missing out all these years. Careful, for it might ruin other languages for you =).
