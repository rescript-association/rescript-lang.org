...
**The complete configuration schema is [here](https://lbovet.github.io/docson/index.html#https://raw.githubusercontent.com/rescript-lang/rescript-compiler/master/docs/docson/build-schema.json)**. We'll _non-exhaustively_ highlight the important parts in prose below.
