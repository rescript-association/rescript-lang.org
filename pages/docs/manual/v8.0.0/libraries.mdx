...
If you can't find what you're looking for: sometimes **you don't need a wrapper** to use a JS library. Most JS data types, such as array and objects, [map over cleanly to ReScript and vice-versa](shared-data-types.md). You also have access to the familiar [JS API](api/js). Be sure to also check the "Interop" and "Converting from JS" sections here!
