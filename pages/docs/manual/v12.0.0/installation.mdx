...
canonical: "/docs/manual/next/installation"
---
...
To start a [rescript-react](/docs/react/next/introduction) app, or to integrate ReScript into an existing ReactJS app, follow the instructions [here](/docs/react/next/installation).
