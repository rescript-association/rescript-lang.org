...
canonical: "/docs/manual/next/jsx"
---
...
**Note** for [ReScriptReact](https://rescript-lang.org/docs/react/next/introduction) readers: this isn't what ReScriptReact turns JSX into, in the end. See Usage section for more info.
...
See [ReScriptReact Elements & JSX](https://rescript-lang.org/docs/react/next/elements-and-jsx) for an example application of JSX, which transforms the above calls into a ReScriptReact-specific call.
