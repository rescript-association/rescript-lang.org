...
canonical: "/docs/manual/next/import-from-export-to-js"
---
...
If you're looking for react-specific interop guidance, check out the [React JS Interop guide](../../react/next/import-export-reactjs.mdx).
