...
- Stable (active / maintenance) & Experimental release channel
- Always use stable releases for libraries!
- You may want to use the experimental release if you want to test new features in your applications and prepare your codebase for the upcoming stable version

## Definition for our Release Channels
