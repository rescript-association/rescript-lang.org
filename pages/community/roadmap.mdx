...
ReScript development is an Open Source effort coordinated by individiual Open Source contributors and members of the [ReScript Association](https://rescript-association.org).
